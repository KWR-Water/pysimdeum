...
def built_house(house_type: str = "", simulate_discharge=False, spillover=False ) -> House:
...
def build_multi_hh(household_data: dict, simulate_discharge=False, spillover=False) -> dict:
